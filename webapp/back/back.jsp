...
<section class="slide-bar">
		<ul>
			<li><a class="a1" href="map.jsp">首页</a></li>
			<li><a class="a1" href="map.jsp">用户管理</a></li>
			<li><a class="a1" href="map.jsp">地理信息管理</a></li>
			<li><a class="a1" href="map.jsp">史料管理</a></li>
			<li><a class="a1" href="map.jsp">关于系统</a></li>
		</ul>
	</section>
	<script>
