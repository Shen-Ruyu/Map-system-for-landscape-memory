...
<%
    try {
        ...
        String sql_update = "select * from yangtzeriverscenery.scenery where name='" +name+ "'";
        //获取你要更新数据的id的数据库信息
...
<form action="geo_doupdate.jsp?name=<%=rs.getString("name")%>" method="post">
	<fieldset>
		<legend>地理信息修改</legend>
		<label for="">
			名称: <input type="text" value="<%=rs.getString("name")%>" name="name">
		</label>
		<label for="">
			地址: <input type="text" value="<%=rs.getString("address") %>" name="address">
		</label>
		<label for="">
			经度: <input type="text" value="<%=rs.getString("lng") %>" name="lng">
		</label>
		<label for="">
			纬度: <input type="text" value="<%=rs.getString("lat") %>" name="lat">
		</label>
		<label for="">
			城市: <input type="text" value="<%=rs.getString("city") %>" name="city">
		</label>
		<label for="">
			省份: <input type="text" value="<%=rs.getString("province") %>" name="province">
		</label>
		<label for="">
			介绍: <input style="word-wrap: break-word;" type="text" value="<%=rs.getString("introduction") %>" name="introduction">
		</label>
