...
<div class="div2">
<% String name=new String(request.getParameter("poetry"));
...
%>
   ...
   <%
     ...
     try{
    	 ...
    	 String sql="select * from yangtzeriverscenery.poetry where title like '%"+name+"%'";
    	 ResultSet rs=stmt.executeQuery(sql);
    	 while(rs.next()){
   %>

      <h1><%=rs.getString("title") %></h1>
      <p><%=rs.getString("dynasty") %>  <%=rs.getString("charac_name") %>  <%=rs.getString("poetry_type") %></p>
