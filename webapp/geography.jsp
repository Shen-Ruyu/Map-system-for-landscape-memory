...
<div class="search d1">
<h6 align="center">地理信息管理</h6>
	  <form name="form" method="post" action="geo_show.jsp">
	  <input type="text" name="user" placeholder="请输入地名...">
...
<div  class="container2">
			...
			<tr>
                ...
                <th width="130px">经度</th>
                <th width="130px">纬度</th>
                <th width="80px">城市</th>
                <th width="80px">省份</th>
...
try{
    	 ...
    	 String sql="select * from yangtzeriverscenery.scenery";
...
<td style="text-align: center;"><a class="btn btn-default btn-sm" href="geo_update.jsp?name=<%=rs.getString("name")%>">修改</a>&nbsp;</td>
   </tr>
   <%
    	 }
     }catch (Exception ex){
